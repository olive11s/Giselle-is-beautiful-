...
<style>
    ...
    #noMessage {
        ...
        height: 60px; text-align: center; padding: 0 20px; z-index: 60;
    }
    ...
    .btn { 
        ...
        border: none; cursor: pointer; position: absolute; transition: transform 0.2s;
    }

    #yesBtn { 
        background: #ff4d94; color: white; 
        top: 70%; left: 50%; transform: translate(-50%, -50%);
        box-shadow: 0 0 15px #ff0000, 0 0 30px #ff4d94;
        z-index: 40;
        animation: glowPulse 2s infinite;
    }

    @keyframes glowPulse {
        0% { box-shadow: 0 0 10px #ff0000, 0 0 20px #ff4d94; }
        50% { box-shadow: 0 0 25px #ff3333, 0 0 50px #ff4d94; }
        100% { box-shadow: 0 0 10px #ff0000, 0 0 20px #ff4d94; }
    }
    ...
    .countdown-box {
        margin-top: 15px; font-size: 15px; color: #d6336c; 
        font-weight: bold; background: #fff; padding: 10px; border-radius: 10px;
    }
...
<div id="finalMessage">
    <div class="message-card">
        <h1 style="color: #ff4d94; font-size: 24px;">Yay! 💖</h1>
        <p style="font-size: 17px; color: #555; line-height: 1.5; text-align: left;">
            I love you Giselle with all my heart! Waking up each day is a blessing because I have you! 
            <br><br>
            You are beautiful, smart, kind, sweet and perfect! I can’t wait for us to keep growing together and build a life together.
        </p>
        <div class="countdown-box">
            Counting down to Seattle: <br>
            <span id="countdownText"></span> 🏔️✈️
        </div>
...
function updateCountdown() {
    ...
    if (distance < 0) {
        document.getElementById("countdownText").innerHTML = "We're in Seattle! 🏔️";
        return;
    }
    ...
    document.getElementById("countdownText").innerHTML = `${days}d ${hours}h ${minutes}m`;
}
